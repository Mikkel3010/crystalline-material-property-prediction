...
def get_train_val_test_loader(dataset, collate_fn=default_collate,
                              batch_size=256, train_val_test_ratio=(0.6, 0.2, 0.2), num_workers=5,
                              pin_memory=True):
